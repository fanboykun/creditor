        ...
        <div class="max-w-full mx-auto space-y-6 drop-shadow-lg">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="px-4 sm:px-0">
                    <h3 class="mb-4 text-2xl font-bold text-gray-700">Detail Pinjaman Nasabah <a href="{{ route('customers.profile', $loan->customer) }}" wire:navigate class="underline">{{ $loan?->customer->name }}</a></h3>
