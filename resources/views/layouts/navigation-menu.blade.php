        ...
        <nav aria-label="Main Nav" class="mt-6 flex flex-col space-y-2">
            ...
            <section>
                ...
                <nav aria-label="Teams Nav" class="mt-2 flex flex-col px-4">
                    <a href="{{ route('customers.index') }}" class="flex items-center gap-2 rounded-lg px-4 py-2 {{ request()->routeIs('customers.index') ? 'bg-white text-indigo-800/95' : 'text-white hover:bg-gray-100/50' }}">
                    ...
                    <a href="{{ route('customers.create') }}" class="flex items-center gap-2 rounded-lg px-4 py-2 {{ request()->routeIs('customers.create') ? 'bg-white text-indigo-800/95' : 'text-white hover:bg-gray-100/50' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <section>
                ...
                <nav aria-label="Teams Nav" class="mt-2 flex flex-col px-4">
                <a href="{{ route('loans.index') }}" class="flex items-center gap-2 rounded-lg px-4 py-2 {{ request()->routeIs('loans.index') ? 'bg-white text-indigo-800/95' : 'text-white hover:bg-gray-100/50' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                    </svg>
                ...
                <a href="{{ route('loans.create') }}" class="flex items-center gap-2 rounded-lg px-4 py-2 {{ request()->routeIs('loans.create') ? 'bg-white text-indigo-800/95' : 'text-white hover:bg-gray-100/50' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
            ...
            <section>
                ...
                <nav aria-label="Teams Nav" class="mt-2 flex flex-col px-4">
                    <a href="{{ route('installments.index') }}" class="flex items-center gap-2 rounded-lg px-4 py-2 {{ request()->routeIs('installments.index') ? 'bg-white text-indigo-800/95' : 'text-white hover:bg-gray-100/50 ' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                        </svg>
                    ...
                    <a href="{{ route('installments.create') }}" class="flex items-center gap-2 rounded-lg px-4 py-2 {{ request()->routeIs('installments.create') ? 'bg-white text-indigo-800/95' : 'text-white hover:bg-gray-100/50' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
