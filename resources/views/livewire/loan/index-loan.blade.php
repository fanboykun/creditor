            ...
            <div class="relative overflow-hidden bg-white shadow-md  sm:rounded-lg">
                ...
                <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
                    <div class="w-full md:w-1/2">
                        <div class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input wire:model.live.debounce.500ms="s" type="search" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2" placeholder="Cari pinjaman berdasarkan id peminjaman atau nama peminjam" required="">
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col flex-shrink-0 space-y-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3">
                        ...
                        <a href="{{ route('loans.create') }}" wire:navigate class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-lg bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 focus:outline-none">
